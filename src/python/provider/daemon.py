...
"""
Code in this file has been taken from The Python Cookbook and
is copyrighted under the following license:
...
__revision__ = "$Id: daemon.py,v 1.1 2007-06-16 18:01:50 hanke Exp $"
__version__ = "0.2"
